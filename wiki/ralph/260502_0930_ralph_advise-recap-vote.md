...
**A6. 9개 비교군 backtest — vote_style 정책 충실성 검증 (8 운용사 + NPS)**
*(코붕이 지시: "실제 운용사들이 어떻게 보팅했었는지에 대한 비교군이있잖아 그거랑 얼추 맞아야 되는거 아닌가?")*

vote_style 옵션 받으면 그 운용사/NPS 정책으로 advise 결정해야 함. 실제 records와 일치율로 정책 해석 정확성 검증.
...
- **NPS** (국민연금): nps_list_2023.json + nps_list_2025.json (자산 1,200조원, KOSPI 200 다수 5%+ 보유, 한국 최대 기관투자자)

**검증 회사 셋** (8 운용사 + NPS 모두 행사한 KOSPI 대형 — 동일 안건 비교 가능):
...
→ A5(얼라인 단일)는 advise 추천 합리성 검증, A6(9 비교군)는 vote_style 충실성 검증. 둘 다 필요.
